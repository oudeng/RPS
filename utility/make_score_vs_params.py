...
for neural agent families (Fig S8 in v5.10 SI).
...
# ---------- data ----------
# Values from v5.10 Table S13 (which matches Table 2 / method_stats.csv)
DATA = {
...
# Save
OUT_PAPER = "/home/dengou/RPS/paper_RPS/Fig/RPS_sophistication/score_vs_params.png"
